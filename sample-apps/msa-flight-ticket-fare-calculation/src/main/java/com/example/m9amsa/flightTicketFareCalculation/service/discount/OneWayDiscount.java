 ...
 * 
 */
@Component("oneWayDiscount")
public class OneWayDiscount implements DiscountCalculator {

    /**
     * {@inheritDoc}
     * 
     * <pre>
     * 片道運賃では、搭乗クラス加算額とピーク時期積算比率から求める基本運賃をそのまま使用します。
     * </pre>
     */
    @Override
     ...
     * この計算ロジックの対象割引を取得します。
     * 
     * @return {@code DiscountType.ONE_WAY}。
     */
    @Override
    public DiscountType targetDiscountId() {
        return DiscountType.ONE_WAY;
    }
