 ...
 * 
 */
@Component("reserve1Discount")
public class Reserve1Discount implements DiscountCalculator {

    /**
     * {@inheritDoc}
     * 
     * <pre>
     * 予約割１では、搭乗クラス加算額とピーク時期積算比率から求める基本運賃から予約割１の割引額を引いた金額を使用します。
     * </pre>
     */
    @Override
     ...
     * この計算ロジックの対象割引を取得します。
     * 
     * @return {@code DiscountType.RESERVE1}。
     */
    @Override
    public DiscountType targetDiscountId() {
        return DiscountType.RESERVE1;
    }
