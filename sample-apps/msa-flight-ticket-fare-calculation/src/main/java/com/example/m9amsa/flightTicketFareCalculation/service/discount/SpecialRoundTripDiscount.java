 ...
 * 
 */
@Component("specialRoundTripDiscount")
public class SpecialRoundTripDiscount implements DiscountCalculator {

    /**
     * {@inheritDoc}
     * 
     * <pre>
     * 特別往復運賃では、搭乗クラス加算額とピーク時期積算比率から求める基本運賃から特別往復運賃の割引額を引いた金額を使用します。
     * </pre>
     */
    @Override
     ...
     * この計算ロジックの対象割引を取得します。
     * 
     * @return {@code DiscountType.SPECIAL_ROUND_TRIP}。
     */
    @Override
    public DiscountType targetDiscountId() {
        return DiscountType.SPECIAL_ROUND_TRIP;
    }
}
