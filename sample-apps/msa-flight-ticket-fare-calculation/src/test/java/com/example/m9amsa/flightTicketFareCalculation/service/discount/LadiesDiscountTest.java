...
public class LadiesDiscountTest {
    ...
    public void testCalcFare() {
        DiscountCalculator discount = discountCalculatorFactory.getCalculator(DiscountType.LADIES);
    ...
    public void testTargetDiscountId() {
        ...
        assertThat("割引タイプが正しいこと", discount.targetDiscountId(), equalTo(DiscountType.LADIES));
    }
