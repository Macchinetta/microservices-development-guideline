...
public class Reserve30DiscountTest {
    ...
    public void testCalcFare() {
        DiscountCalculator discount = discountCalculatorFactory.getCalculator(DiscountType.RESERVE30);
    ...
    public void testTargetDiscountId() {
        ...
        assertThat("割引タイプが正しいこと", discount.targetDiscountId(), equalTo(DiscountType.RESERVE30));
    }
    ...
    public void testIsAvailableTravelDate() {
        ...
        // 搭乗日40日前
        travelDate = LocalDate.now().plusDays(40);

        actual = discount.isAvailableTravelDate(travelDate);

        assertTrue("搭乗日40日前", actual);
