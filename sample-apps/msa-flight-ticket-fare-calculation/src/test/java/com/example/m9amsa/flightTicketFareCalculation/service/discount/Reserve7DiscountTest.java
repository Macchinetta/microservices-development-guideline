...
public class Reserve7DiscountTest {
    ...
    public void testCalcFare() {
        DiscountCalculator discount = discountCalculatorFactory.getCalculator(DiscountType.RESERVE7);
        ...
        assertThat("割引価格が正しいこと", actFare, equalTo(39200));
    }
    ...
    public void testTargetDiscountId() {
        ...
        assertThat("割引タイプが正しいこと", discount.targetDiscountId(), equalTo(DiscountType.RESERVE7));
    }
