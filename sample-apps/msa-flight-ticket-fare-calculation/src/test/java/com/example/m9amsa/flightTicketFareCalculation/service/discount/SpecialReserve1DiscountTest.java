...
public class SpecialReserve1DiscountTest {
    ...
    public void testCalcFare() {
        DiscountCalculator discount = discountCalculatorFactory.getCalculator(DiscountType.SPECIAL_RESERVE1);
        ...
        assertThat("割引価格が正しいこと", actFare, equalTo(44100));
    }
    ...
    public void testTargetDiscountId() {
        ...
        assertThat("割引タイプが正しいこと", discount.targetDiscountId(), equalTo(DiscountType.SPECIAL_RESERVE1));
    }
