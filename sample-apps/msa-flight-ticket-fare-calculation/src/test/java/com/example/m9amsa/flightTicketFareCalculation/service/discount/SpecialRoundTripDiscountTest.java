...
public class SpecialRoundTripDiscountTest {
    ...
    public void testCalcFare() {
        DiscountCalculator discount = discountCalculatorFactory.getCalculator(DiscountType.SPECIAL_ROUND_TRIP);
        ...
        assertThat("割引価格が正しいこと", actFare, equalTo(46550));
    }
    ...
    public void testTargetDiscountId() {
        ...
        assertThat("割引タイプが正しいこと", discount.targetDiscountId(), equalTo(DiscountType.SPECIAL_ROUND_TRIP));
    }
