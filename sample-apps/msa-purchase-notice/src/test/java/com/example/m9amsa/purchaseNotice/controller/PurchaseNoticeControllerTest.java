...
public class PurchaseNoticeControllerTest {

    @Mock
    private PurchaseNoticeService service;

    @InjectMocks
    private PurchaseNoticeController controller;
    ...
    @Test
    public void testpurchaseNotice() throws Exception {

        String emailId = "001@ntt.com";
        controller.purchaseNotice(emailId);
        verify(service).purchaseNotice(captor.capture());
        assertThat("PurchaseNoticeServiceへのパラメータが正しいこと", captor.getValue(), equalTo(emailId));
