...
/**
 * HttpStatusとして401を返却することを表す例外。
 * 
 */
public class HttpStatus401Exception extends RuntimeException {

    private static final long serialVersionUID = 4010678340717565303L;

    public HttpStatus401Exception() {
        super();
    }

    public HttpStatus401Exception(String message, Throwable cause, boolean enableSuppression,
